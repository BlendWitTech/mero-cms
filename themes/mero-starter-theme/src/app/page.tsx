...
import NoThemeActive from '@/components/NoThemeActive';
...
export default async function HomePage() {
  ...
  // Show placeholder when no theme is active
  const activeTheme = (siteData?.settings as any)?.activeTheme;
  if (!activeTheme) {
    return <NoThemeActive />;
  }
