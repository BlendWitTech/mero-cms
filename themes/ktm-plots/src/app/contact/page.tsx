    ...
    <>
      ...
      <div style={{ background: '#CC1414', padding: '4rem 0 3rem' }}>
        <div className="container">
          <div style={{ color: '#CC1414', fontSize: '0.8rem', fontWeight: 700, letterSpacing: '0.1em', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Get In Touch</div>
      ...
      <section style={{ padding: '4rem 0 5rem', background: '#F4F4F4' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', alignItems: 'start' }}>
            {/* Contact info */}
            <div>
              <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#CC1414', marginBottom: '1.5rem' }}>We&apos;d Love to Hear from You</h2>
                  ...
                  {contactItems.map((item) => (
                    <div key={item.label} style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                      <div style={{ width: '42px', height: '42px', background: '#CC1414', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                        {item.icon === 'location' && (
                          <svg width="18" height="18" fill="none" stroke="#CC1414" strokeWidth="2" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
                        )}
                        {item.icon === 'phone' && (
                          <svg width="18" height="18" fill="none" stroke="#CC1414" strokeWidth="2" viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 14a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 3.18h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 10.91a16 16 0 0 0 5 5l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                        )}
                        {item.icon === 'email' && (
                          <svg width="18" height="18" fill="none" stroke="#CC1414" strokeWidth="2" viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                        )}
                      </div>
                      <div>
