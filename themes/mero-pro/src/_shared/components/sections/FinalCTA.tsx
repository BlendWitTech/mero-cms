...
export default function FinalCTA({ data = {} }: { data?: FinalCTAData }) {
    ...
    return (
        <section data-section-id="cta" data-section-type="FinalCTA" className="final-cta-wrap">
            <div className="final-cta reveal-scale">
                <div className="final-cta-content">
                    <h2 className="display" data-editable="title">{d.title}</h2>
                    <p data-editable="subtitle">{d.subtitle}</p>
                ...
                <div className="final-cta-aside" aria-hidden="true">
                    ...
                    <TeamAvatars />
                    <p className="cta-team-label" data-editable="trustText">{d.trustText}</p>
                </div>
            </div>
        </section>
    );
